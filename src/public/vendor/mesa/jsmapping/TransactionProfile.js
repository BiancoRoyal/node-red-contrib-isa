var TransactionProfile_Module_Factory = function () {
    var TransactionProfile = {
        name: 'TransactionProfile',
        defaultElementNamespaceURI: 'http:\/\/www.mesa.org\/xml\/B2MML-V0600',
        typeInfos: [{
            localName: 'GetTransactionProfileType.DataArea',
            typeName: null,
            propertyInfos: [{
                name: 'get',
                required: true,
                ...
                minOccurs: 0,
                collection: true,
                elementName: 'TransactionProfile',
                typeInfo: '.TransactionProfileType'
            }]
        }, {
            ...
            localName: 'TransactionVerbType',
            baseTypeInfo: '.TransactionVerb1Type',
            propertyInfos: [{
                name: 'otherValue',
                attributeName: {
                    localPart: 'OtherValue'
            ...
            localName: 'ShowTransactionProfileType.DataArea',
            typeName: null,
            propertyInfos: [{
                name: 'show',
                required: true,
            ...
            localName: 'TransactionNounType',
            baseTypeInfo: '.TransactionNoun1Type',
            propertyInfos: [{
                name: 'otherValue',
                attributeName: {
                    localPart: 'OtherValue'
            ...
            propertyInfos: [{
                ...
                name: 'transactionVerb',
                required: true,
                elementName: 'TransactionVerb',
                typeInfo: '.TransactionVerbType'
            }, {
                name: 'transactionNoun',
                required: true,
                elementName: 'TransactionNoun',
                typeInfo: '.TransactionNounType'
            }, {
                name: 'informationUser',
                elementName: 'InformationUser',
                typeInfo: 'Boolean'
            }, {
                name: 'informationProvider',
                elementName: 'InformationProvider',
                typeInfo: 'Boolean'
            }, {
                name: 'informationSender',
                elementName: 'InformationSender',
                typeInfo: 'Boolean'
            }, {
                name: 'informationReceiver',
                elementName: 'InformationReceiver',
                typeInfo: 'Boolean'
            }, {
                name: 'objectWildcardSupported',
                elementName: 'ObjectWildcardSupported',
                typeInfo: 'Boolean'
            }, {
                name: 'propertyWildcardSupported',
                elementName: 'PropertyWildcardSupported',
                typeInfo: 'Boolean'
            }, {
                name: 'releaseID',
                required: true,
            ...
            localName: 'GetTransactionProfileType',
            propertyInfos: [{
                ...
                typeInfo: '.GetTransactionProfileType.DataArea'
            }, {
                name: 'releaseID',
                required: true,
                typeInfo: 'NormalizedString',
            ...
            localName: 'TransactionProfileType',
            propertyInfos: [{
                name: 'id',
                elementName: 'ID',
                typeInfo: '.IdentifierType'
                ...
                name: 'supportedAction',
                minOccurs: 0,
                collection: true,
                elementName: 'SupportedAction',
                typeInfo: '.SupportedActionType'
            }, {
                name: 'releaseID',
                required: true,
                typeInfo: 'NormalizedString',
            ...
            localName: 'TransactionNoun1Type',
            baseTypeInfo: '.CodeType'
        }, {
            ...
            localName: 'TransactionVerb1Type',
            baseTypeInfo: '.CodeType'
        }, {
            ...
            localName: 'ShowTransactionProfileType',
            propertyInfos: [{
                name: 'applicationArea',
                required: true,
                elementName: 'ApplicationArea',
                ...
                required: true,
                elementName: 'DataArea',
                typeInfo: '.ShowTransactionProfileType.DataArea'
            }, {
                name: 'releaseID',
                required: true,
                typeInfo: 'NormalizedString',
        ...
        elementInfos: [{
            ...
            elementName: 'GetTransactionProfile',
            typeInfo: '.GetTransactionProfileType'
        }, {
            elementName: 'UnitOfMeasure',
            typeInfo: '.UnitOfMeasureType',
            scope: '.ResultType'
            ...
            elementName: 'ShowTransactionProfile',
            typeInfo: '.ShowTransactionProfileType'
        }]
    };
    return {
...
if (typeof define === 'function' && define.amd) {
    define([], TransactionProfile_Module_Factory);
}
else {
    var TransactionProfile_Module = TransactionProfile_Module_Factory();
    if (typeof module !== 'undefined' && module.exports) {
        module.exports.TransactionProfile = TransactionProfile_Module.TransactionProfile;
    }
    else {
        var TransactionProfile = TransactionProfile_Module.TransactionProfile;
    }
}